...
<div id="hero-carousel" class="relative w-full h-[400px] sm:h-[500px] md:h-[700px] overflow-hidden group">
    <!-- Slides Container -->
        ...
        <div class="carousel-item absolute inset-0 opacity-100 pointer-events-auto transition-opacity duration-1000 ease-in-out">
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex items-center">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl">
                        <h1 class="text-3xl sm:text-4xl md:text-7xl font-extrabold text-white leading-tight">
                            <span class="block text-secondary">Kesatuan Guru-Guru Sabah</span>
                            <span class="block mt-2">Memperkasa Pendidik Tempatan</span>
                        </h1>
        ...
        <div class="carousel-item absolute inset-0 opacity-0 pointer-events-none transition-opacity duration-1000 ease-in-out">
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex items-center">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl">
                        <h1 class="text-3xl sm:text-4xl md:text-7xl font-extrabold text-white leading-tight">
                            <span class="block text-secondary">Kecemerlangan Pengajaran</span>
                            <span class="block mt-2">Membina Masa Depan Kita</span>
                        </h1>
        ...
        <div class="carousel-item absolute inset-0 opacity-0 pointer-events-none transition-opacity duration-1000 ease-in-out">
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex items-center">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl">
                        <h1 class="text-3xl sm:text-4xl md:text-7xl font-extrabold text-white leading-tight">
                            <span class="block text-secondary">Perpaduan Dalam Kepelbagaian</span>
                            <span class="block mt-2">Lebih Kuat Bersama</span>
                        </h1>
        ...
        <div class="carousel-item absolute inset-0 opacity-0 pointer-events-none transition-opacity duration-1000 ease-in-out">
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex items-center">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl">
                        <h1 class="text-3xl sm:text-4xl md:text-7xl font-extrabold text-white leading-tight">
                            <span class="block text-secondary">Bentuk Hari Esok</span>
                            <span class="block mt-2">Komitmen Hari Ini</span>
                        </h1>
        ...
        <div class="carousel-item absolute inset-0 opacity-0 pointer-events-none transition-opacity duration-1000 ease-in-out">
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex items-center">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl">
                        <h1 class="text-3xl sm:text-4xl md:text-7xl font-extrabold text-white leading-tight">
                            <span class="block text-secondary">Sertai Kesatuan</span>
                            <span class="block mt-2">Suara Kemajuan</span>
                        </h1>
    ...
    <!-- Navigation Controls -->
    <button id="prevBtn" class="absolute left-2 sm:left-8 top-1/2 -translate-y-1/2 p-2 sm:p-4 rounded-full bg-black/30 text-white backdrop-blur-md transition-all duration-300 hover:bg-black/50 border border-white/10 z-20">
    ...
    <button id="nextBtn" class="absolute right-2 sm:right-8 top-1/2 -translate-y-1/2 p-2 sm:p-4 rounded-full bg-black/30 text-white backdrop-blur-md transition-all duration-300 hover:bg-black/50 border border-white/10 z-20">
    ...
    <!-- Indicators -->
    <div id="indicators" class="absolute bottom-5 sm:bottom-10 left-1/2 -translate-x-1/2 flex gap-2 sm:gap-4 z-20">
        <button class="indicator w-8 sm:w-12 h-1 sm:h-2 rounded-full bg-white transition-all duration-300" data-slide="0"></button>
        <button class="indicator w-3 sm:w-4 h-1 sm:h-2 rounded-full bg-white/50 hover:bg-white/80 transition-all duration-300" data-slide="1"></button>
        <button class="indicator w-3 sm:w-4 h-1 sm:h-2 rounded-full bg-white/50 hover:bg-white/80 transition-all duration-300" data-slide="2"></button>
        <button class="indicator w-3 sm:w-4 h-1 sm:h-2 rounded-full bg-white/50 hover:bg-white/80 transition-all duration-300" data-slide="3"></button>
        <button class="indicator w-3 sm:w-4 h-1 sm:h-2 rounded-full bg-white/50 hover:bg-white/80 transition-all duration-300" data-slide="4"></button>
    </div>
</div>
