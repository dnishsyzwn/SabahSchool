...
<div id="hero-carousel" class="relative w-full h-[90vh] overflow-hidden group">
    <!-- Slides Container -->
    <div id="carousel-inner" class="relative w-full h-full">
        ...
        <div class="carousel-item absolute inset-0 opacity-100 pointer-events-auto transition-opacity duration-1000 ease-in-out">
            <img src="{{ asset('assets/images/home_hero_1.png') }}" class="absolute block w-full h-full object-cover" alt="Suasana Bilik Darjah Moden - Sabah Teachers Union">
                ...
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl">
                        <h1 class="text-3xl sm:text-4xl md:text-7xl font-extrabold text-white leading-tight">
                            <span class="block text-secondary">Sabah Teachers Union (STU)</span>
                        </h1>
        ...
        <div class="carousel-item absolute inset-0 opacity-0 pointer-events-none transition-opacity duration-1000 ease-in-out">
            <img src="{{ asset('assets/images/home_hero_2.png') }}" class="absolute block w-full h-full object-cover" alt="Meja Guru dan Persediaan Akademik - Sabah Teachers Union">
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex items-center">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl">
                        <h2 class="text-3xl sm:text-4xl md:text-7xl font-extrabold text-white leading-tight">
                            <span class="block text-secondary">Sabah Teachers Union (STU)</span>
                        </h2>
                        <div class="mt-6 sm:mt-10 flex flex-wrap gap-4">
                            <a href="{{ url('/keahlian') }}" class="group relative overflow-hidden px-6 py-3 sm:px-10 sm:py-4 bg-[#001a6e] text-secondary rounded-xl font-bold hover:scale-105 hover:shadow-[0_0_20px_rgba(254,178,26,0.3)] active:scale-95 transition-all duration-300 text-base sm:text-lg inline-block border border-white/10 hover:border-secondary/50">
        ...
        <!-- Slide 3 -->
        <div class="carousel-item absolute inset-0 opacity-0 pointer-events-none transition-opacity duration-1000 ease-in-out">
            <img src="{{ asset('assets/images/home_hero_3.png') }}" class="absolute block w-full h-full object-cover" alt="Suasana Perpustakaan dan Sumber Ilmu - Sabah Teachers Union">
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex items-center">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="max-w-2xl">
                        <h2 class="text-3xl sm:text-4xl md:text-7xl font-extrabold text-white leading-tight">
