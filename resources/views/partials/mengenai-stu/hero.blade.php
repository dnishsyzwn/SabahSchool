...
<div class="relative bg-[#1a1c23] pt-20 pb-20 md:pt-24 md:pb-32 overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-20 pointer-events-none">
        ...
        <img src="{{ asset('images/stu-logo.webp') }}" alt="Background Pattern"
            class="w-full h-full object-cover scale-150 blur-[2px]">
    </div>

    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        <!-- Logo -->
        <div class="mb-6 animate-fade-in-up">
            <img src="{{ asset('images/stu-logo.webp') }}" alt="STU Logo"
                class="h-32 md:h-40 w-auto drop-shadow-[0_0_25px_rgba(255,255,255,0.2)]">
        </div>
