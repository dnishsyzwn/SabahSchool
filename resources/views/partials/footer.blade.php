    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" target="_blank" class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#1877F2] transition-colors group" title="Kongsi di Facebook">
                ...
                <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode('Sabah Teachers Union (STU)') }}" target="_blank" class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#1DA1F2] transition-colors group" title="Kongsi di Twitter">
                ...
                <a href="https://api.whatsapp.com/send?text={{ urlencode('Sabah Teachers Union (STU): ' . url()->current()) }}" target="_blank" class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#25D366] transition-colors group" title="Kongsi di WhatsApp">
