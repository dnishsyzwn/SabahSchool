            ...
            <tr class="block lg:table-row bg-white hover:bg-blue-50/30 transition group/row animate-in fade-in duration-500 mb-4 lg:mb-0 border border-gray-100 lg:border-none rounded-2xl lg:rounded-none overflow-hidden ">
                ...
                <td class="block lg:table-cell px-6 pt-6 pb-2 lg:py-4">
                    <div class="flex items-center gap-4">
                        <div class="lg:hidden">
                             <span class="text-[10px] font-black text-blue-600 bg-blue-50 px-2 py-1 rounded-md">#{{ $posts->firstItem() + $loop->index }}</span>
                        </div>
                        @if($post->thumbnail)
                        ...
                        <div class="flex-1 lg:hidden">
                            ...
                            <div class="flex items-center gap-1.5 mt-1">
                                ...
                                <p class="text-[9px] font-black text-gray-400 uppercase tracking-widest">{{ $post->category?->name ?? 'Kategori' }}</p>
                            </div>
                        </div>
                    </div>
                </td>
                ...
                <td class="block lg:table-cell px-6 py-2 lg:py-4 border-t border-gray-50 lg:border-none">
                    <div class="grid grid-cols-2 lg:block gap-4">
                        ...
                        <div class="flex flex-col lg:flex-row lg:items-center gap-1 lg:gap-3">
                            <span class="lg:hidden text-[9px] font-black text-gray-400 uppercase tracking-widest">Penulis</span>
                            <div class="flex items-center gap-2">
                                <div class="w-6 h-6 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center text-[9px] font-black uppercase">
                        ...
                        <div class="flex flex-col lg:hidden gap-1">
                            ...
                            @endphp
                            <div>
                                <span class="inline-flex items-center px-2 py-0.5 text-[9px] font-black rounded-md border {{ $badge }} uppercase tracking-tighter">
                                    {{ $post->status }}
                                </span>
                            </div>
                        </div>
...
@if($posts->hasPages())
    <div class="px-6 py-4 border-t border-gray-50 bg-gray-50/30 flex flex-col lg:flex-row items-center justify-between gap-4 table-pagination">
        <div class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">
            Menunjukkan <span class="text-blue-600">{{ $posts->firstItem() }}</span> ke <span class="text-blue-600">{{ $posts->lastItem() }}</span> daripada <span class="text-blue-600">{{ $posts->total() }}</span> rekod
        </div>
