...
@section('header', 'Tambah Aktiviti Baru')
...
<div class="max-w-4xl mx-auto">
    <form action="{{ route('admin.activities.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="category" value="{{ old('category') }}" placeholder="Contoh: KEBAJIKAN" required
                    ...
                    <div>
                        ...
                        <input type="text" name="location" value="{{ old('location') }}" placeholder="Contoh: SK Karamunting, Sandakan"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none">
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Jumlah / Pampasan (Opsional)</label>
                        <input type="text" name="amount" value="{{ old('amount') }}" placeholder="Contoh: RM 10,000.00"
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none">
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
                        <input type="checkbox" name="is_featured" value="1" id="is_featured" class="w-4 h-4 text-blue-600 rounded">
        ...
        <div class="flex items-center justify-end gap-3">
            ...
            <button type="submit" class="px-8 py-2 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition shadow-md shadow-blue-200">Simpan Aktiviti</button>
        </div>
    </form>
</div>
@endsection
