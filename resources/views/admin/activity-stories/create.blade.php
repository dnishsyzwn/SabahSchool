...
@section('header', 'Tambah Cerita Aktiviti Kami')
...
<div class="max-w-6xl mx-auto">
    <form action="{{ route('admin.activity-stories.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        @csrf
        ...
        <div class="lg:col-span-8 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" required placeholder="Masukkan tajuk aktiviti..."
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="tag" value="{{ old('tag') }}" required placeholder="Cth: Kebajikan, Bantuan"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="event_date" id="event_date" value="{{ old('event_date') }}" required placeholder="Pilih Tarikh..."
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="6" required placeholder="Ceritakan sedikit tentang aktiviti yang telah dijalankan..."
                                  class="w-full px-4 py-3 border border-gray-100 bg-gray-50/30 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition text-sm text-gray-700 leading-relaxed">{{ old('description') }}</textarea>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6" x-data="imageUpload()" x-init="initSortable()">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-6">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="pt-4 border-t border-gray-50 space-y-3">
                        <button type="submit" class="w-full py-4 bg-blue-600 text-white font-black text-[11px] uppercase tracking-[0.2em] rounded-xl hover:bg-blue-700 transition shadow-xl shadow-blue-100 hover:shadow-blue-200 hover:-translate-y-0.5 transition-all duration-300">
                            Simpan Cerita Aktiviti
                        </button>
                        <a href="{{ route('admin.activity-stories.index') }}" class="w-full flex items-center justify-center py-4 bg-gray-50 text-gray-400 font-black text-[11px] uppercase tracking-[0.2em] rounded-xl hover:bg-gray-100 transition border border-gray-100">
                            Batal
                        </a>
                    </div>
                </div>
...
<script>
    ...
    async function openCropModal(file, ratio = NaN){
        return new Promise(async (res,rej)=>{
            ...
            if (file.name.toLowerCase().endsWith('.heic') || file.type.includes('heic') || file.type.includes('heif')) {
                Swal.fire({ 
                    title: 'Memproses Imej iPhone...', 
                    text: 'Sila tunggu sementara kami menukarkan format imej anda.', 
            ...
            img.onload=()=>{ 
                ...
                // Set default UI state for AR buttons
    ...
    function _endCrop(blob){
        ...
        const r=_cropResolve; _cropResolve=null; _cropReject=null; 
        if(r)r(f);
    }
    ...
    document.getElementById('btn-crop-skip').addEventListener('click',()=>{ 
        if(!_cropper||!_cropResolve)return;
        const btn=document.getElementById('btn-crop-skip'); 
        btn.textContent='...'; 
        btn.disabled=true;
    ...
    document.querySelectorAll('.crop-ar').forEach(btn=>btn.addEventListener('click',()=>{
        ...
        document.querySelectorAll('.crop-ar').forEach(b=>{ 
            b.classList.remove('bg-white','shadow-sm','border-transparent'); 
            b.classList.add('text-gray-400'); 
        });
        btn.classList.add('bg-white','shadow-sm','border-transparent'); 
    ...
    function imageUpload() {
        return {
            ...
            initSortable() {
                this.$nextTick(() => {
                    ...
                    Sortable.create(el, {
                        ...
                        onEnd: (evt) => {
                            // Sync imageUrls array with new DOM order
            ...
            async processFiles(files) {
                ...
                this.initSortable(); // Refresh sortable after adding new items
            },
