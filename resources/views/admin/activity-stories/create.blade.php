    ...
    function imageUpload() {
        return {
            ...
            async handleUpload(e) {
                ...
                try {
                    // Open Crop Modal - suggest 4:3 or similar (Activity page uses aspect-square or aspect-square-ish)
                    // Let's use NaN (Free crop) as default but allow ratio buttons
