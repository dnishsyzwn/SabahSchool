...
@section('content')
    <div
        class="bg-white rounded-2xl shadow-xl shadow-gray-100/50 border border-gray-100 overflow-hidden transition-all duration-500">
        ...
        <div class="p-6 border-b border-gray-50 bg-gray-50/30 flex flex-col lg:flex-row items-center gap-6">
            ...
            <form id="filter-form" method="GET" action="{{ route('admin.activity-stories.index') }}"
                class="flex flex-col sm:flex-row flex-[2] gap-3 w-full">
                {{-- Dynamic Search --}}
                <div class="relative flex-1 group">
                    ...
                    <svg class="absolute left-3.5 top-3 w-4 h-4 text-gray-300 group-focus-within:text-blue-500 transition-colors"
                ...
                <div class="flex items-center gap-2 sm:w-auto">
                    <div class="relative group flex-1 sm:w-36">
                        <span
                            class="absolute left-3 top-[-8px] bg-white px-1 text-[8px] font-black text-gray-400 uppercase tracking-widest z-10 transition-colors group-focus-within:text-blue-500">Mula</span>
                    ...
                    <div class="relative group flex-1 sm:w-36">
                        <span
                            class="absolute left-3 top-[-8px] bg-white px-1 text-[8px] font-black text-gray-400 uppercase tracking-widest z-10 transition-colors group-focus-within:text-blue-500">Hingga</span>
