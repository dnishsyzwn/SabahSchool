<div class="overflow-x-auto relative min-h-[400px]">
    ...
    <table class="min-w-full block lg:table text-left text-sm">
        ...
        <tbody class="block lg:table-row-group divide-y divide-gray-50">
            ...
            <tr class="block lg:table-row bg-white hover:bg-blue-50/30 transition group/row animate-in fade-in duration-500 mb-4 lg:mb-0 border border-gray-100 lg:border-none rounded-2xl lg:rounded-none overflow-hidden {{ !$message->is_read ? 'bg-blue-50/10' : '' }}">
                <td class="block lg:table-cell px-6 pt-6 pb-2 lg:py-4">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 lg:w-10 lg:h-10 {{ !$message->is_read ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-400' }} rounded-xl flex items-center justify-center shadow-sm border border-gray-100 transition group-hover/row:scale-110">
                ...
                <td class="block lg:table-cell px-6 py-2 lg:py-4 border-t border-gray-50 lg:border-none">
                    <div class="flex flex-col lg:block">
                        <span class="lg:hidden text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">Sekolah / Hubungi</span>
                ...
                <td class="block lg:table-cell px-6 py-2 lg:py-4 border-t border-gray-50 lg:border-none">
                    <div class="flex flex-col lg:block">
                        ...
                        @if(!$message->is_read)
                            <span class="inline-flex items-center px-2 py-0.5 text-[8px] font-black rounded-full bg-blue-100 text-blue-600 uppercase tracking-widest border border-blue-200 w-fit">
                                Baru
                            </span>
                        @else
                            <span class="inline-flex items-center px-2 py-0.5 text-[8px] font-black rounded-full bg-gray-100 text-gray-400 uppercase tracking-widest border border-gray-200 w-fit">
                                Dibaca
                            </span>
                        @endif
                    </div>
                ...
                <td class="block lg:table-cell px-6 py-3 lg:py-4 border-t border-gray-50 lg:border-none">
                    <div class="flex flex-col">
                        <span class="lg:hidden text-[9px] font-black text-gray-400 uppercase tracking-widest mb-1">Tarikh Terima</span>
            ...
            <tr class="block lg:table-row">
                <td colspan="5" class="block lg:table-cell px-6 py-24 text-center">
