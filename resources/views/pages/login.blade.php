...
@section('content')
    <div class="min-h-screen relative flex items-center justify-center py-20 px-4 overflow-hidden bg-primary">
        ...
        <div class="absolute inset-0 z-0">
            <div
                class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-secondary/20 rounded-full blur-[120px] animate-pulse">
            </div>
            <div
                class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-secondary/10 rounded-full blur-[120px] animate-pulse delay-700">
            </div>
            <img src="{{ asset('images/.webp') }}" alt=""
                class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl opacity-[0.03] pointer-events-none select-none">
        </div>
        ...
        <div class="relative z-10 w-full max-w-md animate-fade-in-up">
            ...
            <div class="text-center mb-8">
                <div
                    class="inline-flex items-center justify-center w-20 h-20 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 mb-6 shadow-xl">
                    <img src="{{ asset('images/stu-logo.webp') }}" alt="STU Logo" class="w-14 h-14 object-contain">
                </div>
                <h1 class="text-3xl font-black text-white uppercase tracking-tighter mb-2">Portal <span
                        class="text-secondary">Admin</span></h1>
            ...
            <!-- Glassmorphism Card -->
            <div
                class="bg-white/10 backdrop-blur-2xl rounded-[2.5rem] p-8 md:p-10 border border-white/20 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]">
                <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <label for="email"
                            class="block text-xs font-bold text-white/50 uppercase tracking-widest ml-1">Alamat Emel</label>
                        <div class="group relative">
                            <div
                                class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-white/30 group-focus-within:text-secondary transition-colors">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between px-1">
                            <label for="password"
                                class="block text-xs font-bold text-white/50 uppercase tracking-widest">Kata Laluan</label>
                            <a href="#"
                                class="text-[10px] font-bold text-secondary/60 hover:text-secondary uppercase tracking-wider transition-colors">Lupa?</a>
                        </div>
                        <div class="group relative">
                            <div
                                class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-white/30 group-focus-within:text-secondary transition-colors">
                            ...
                            <button type="button" id="toggle-password"
                                class="absolute inset-y-0 right-0 pr-4 flex items-center text-white/30 hover:text-secondary transition-colors">
                    ...
                    <div class="flex items-center px-1">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            ...
                            <span class="text-xs font-medium text-white/60 group-hover:text-white transition-colors">Ingat
                                Saya</span>
                        </label>
                    </div>
                    ...
                    <div class="px-1">
                        <div class="cf-turnstile" data-sitekey="{{ config('services.cloudflare.site_key') }}"
                            data-theme="dark"></div>
