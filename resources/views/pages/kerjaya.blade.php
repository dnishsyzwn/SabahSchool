            ...
            <div class="bg-white rounded-3xl shadow-2xl shadow-primary/5 border border-gray-100 overflow-hidden">
                <div class="grid md:grid-cols-5">
                    <div class="md:col-span-2 bg-primary p-8 md:p-12 text-white flex flex-col justify-between">
                        <div>
                            ...
                            <p class="text-white/80 leading-relaxed mb-8">
                                Berminat untuk menyertai warga Sabah Teachers Union? Sila lengkapkan borang di sebelah dan
                                sertakan resume anda.
                            </p>
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <!-- email_off --><a href="mailto:admin@sabahteachersunion.com" class="font-medium text-xs hover:text-secondary transition-colors">admin@sabahteachersunion.com</a><!-- email_on -->
                                    </div>
                                </div>
                                <div class="flex items-start gap-4">
                                    <div
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-xs">1ST FLOOR, LOT 5, BLOCK 25,
                                            BANDAR INDAH, JALAN UTARA,
                    ...
                    <div class="md:col-span-3 p-8 md:p-12">
                        @if(session('success'))
                            <div
                                class="mb-8 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 rounded-r-xl animate-fade-in-up">
                        ...
                        <form action="{{ route('kerjaya.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    <label for="name"
                                        ...
                                        Penuh <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    <label for="alamat"
                                        ...
                                        Menetap <span class="text-red-500">*</span></label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        <label for="email"
                                            class="block text-sm font-bold text-gray-700 uppercase tracking-wider mb-2">E-mel
                                    ...
                                    <div>
                                        <label for="phone"
                                            class="block text-sm font-bold text-gray-700 uppercase tracking-wider mb-2">No.
                                ...
                                <div>
                                    <label for="resume"
                                        class="block text-sm font-bold text-gray-700 uppercase tracking-wider mb-2">Muat
                                        Naik Resume (PDF/DOC) <span class="text-red-500">*</span></label>
                                    <div class="relative">
                                        <input type="file" name="resume" id="resume" class="hidden" accept=".pdf,.doc,.docx"
                                            onchange="document.getElementById('file-name').textContent = this.files[0].name">
                                        <label for="resume"
                                            class="flex items-center justify-between w-full px-4 py-3 bg-gray-50 border {{ $errors->has('resume') ? 'border-red-400' : 'border-gray-200' }} rounded-xl cursor-pointer hover:bg-gray-100 transition-colors">
                                    ...
                                    <p class="mt-1 text-[10px] text-gray-400">Format: PDF, DOC atau DOCX. Saiz maksimum:
                                        10MB</p>
                                ...
                                <div>
                                    <label for="message"
                                        class="block text-sm font-bold text-gray-700 uppercase tracking-wider mb-2">Mesej
                                        Tambahan (Pilihan)</label>
